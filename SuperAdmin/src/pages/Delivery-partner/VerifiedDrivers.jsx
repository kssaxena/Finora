          ...
          <table className="min-w-full bg-white border border-gray-200">
            <thead>
              <tr>
                ...
                <th className="py-2 px-4 border-b">Active Order</th>
              ...
              {allDrivers?.length > 0 ? (
                allDrivers.map((driver) => (
                  <tr key={driver._id} className="hover:bg-gray-100">
                    ...
                    <td className="py-2 px-4 border-b">{driver.isActive}</td>
                    <td className="py-2 px-4 border-b">{driver.activeOrder}</td>
                    <td className="py-2 px-4 border-b">
