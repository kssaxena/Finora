...
const Hero = () => {
  ...
  return (
    <div className="">
      ...
      <div className="lg:flex justify-center items-center text-black lg:text-4xl text-base font-sans lg:absolute relative backdrop-blur lg:h-20 w-full">
        <h1 className="w-full text-center ">
          Welcome to <span className="text-red-700">Finora</span> Billing Solution for Everyone
        </h1>
      </div>
